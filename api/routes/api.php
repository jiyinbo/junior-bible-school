...
use App\Http\Controllers\Api\V1\Admin\ModuleScheduleController;
...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware('auth:sanctum')->group(function (): void {
        ...
        Route::middleware(['role:admin,teacher'])->prefix('staff')->group(function (): void {
        ...
        Route::middleware(['role:admin'])->prefix('admin')->group(function (): void {
            ...
            Route::patch('modules/{jbs_module}/schedule', [ModuleScheduleController::class, 'update']);
        ...
        Route::middleware(['role:admin,teacher'])->prefix('admin')->group(function (): void {
